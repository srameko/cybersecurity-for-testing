---
layout: section
subtitle: To nejdůležitější, co byste měly vědět
---
...
<div class="icon-grid">
  <div class="icon-card">
    <div class="icon">🔄</div>
    <div class="label">Pravidelně aktualizujte</div>
  </div>
  <div class="icon-card">
    <div class="icon">🦠</div>
    <div class="label">Chraňte se před malwarem</div>
  </div>
  <div class="icon-card">
    <div class="icon">🔑</div>
    <div class="label">Silná hesla + MFA</div>
  </div>
  <div class="icon-card">
    <div class="icon">💾</div>
    <div class="label">Zálohujte</div>
  </div>
  <div class="icon-card">
    <div class="icon">🔒</div>
    <div class="label">Šifrujte disk</div>
  </div>
  <div class="icon-card">
    <div class="icon">🖥️</div>
    <div class="label">Zabezpečte počítač</div>
  </div>
</div>
---
layout: default
